...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const batchRegistryAddress = "0xbca09b5c1Fc2bF789Dd74c2fF57443CE90221501";
  console.log("BatchRegistry deployed to:", batchRegistryAddress);

  // batchRegistry.updateAllowList([deployer], [true]);

  await deploy("CheckIn", { from: deployer, args: [batchRegistryAddress], log: true, autoMine: true });
